...
<aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
  <!-- Logo -->
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item pl-3 border-top border-bottom py-2 font-weight-bold" style="letter-spacing: .3px"><span>Point of Sale</span> </li>

      <?php if ($permission[27] || $permission[28] || $permission[29]) { ?>
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#menu_setup" aria-expanded="false" aria-controls="menu_setup">
        <i class="material-icons">fastfood</i> Menu Setup
        </a>
        <ul id="menu_setup" class="collapse" aria-labelledby="menu_setup">
          <?php if ($permission[1]) { ?>
            <li><a href="<?= base_url().'menugroup' ?>">Menu Group</a></li>
          <?php } ?>
          <?php if ($permission[1]) { ?>
      ...
      <?php if ($permission[30]) { ?>
      <li class="menu-item"><a href="<?= base_url().'discountsetup'?>"><i class="fas fa-percent"></i> Discount Setup</a></li>
      <?php } ?>
      <?php if ($permission[31]) { ?>
      <li class="menu-item"><a href="<?= base_url().'payment' ?>"><i class="fas fa-money-check-alt"></i> Payment Setup</a></li>
      <?php } ?>
      <?php if ($permission[30]) { ?>
      <li class="menu-item"><a href="<?= base_url().'postschedule'?>"><i class="fas fa-clock"></i> Employee Scheduling</a></li>
      <?php } ?>
      <?php if ($permission[33]) { ?>
      <li class="menu-item"><a href="<?= base_url().'cashtray' ?>"><i class="fas fa-coins"></i> Cash Tray</a></li>
      <?php } ?>
      <?php if ($permission[35]) { ?>
      <li class="menu-item"><a href="<?= base_url().'recall' ?>"><i class="fas fa-sync"></i> Recall</a></li>
      <?php } ?>
      <?php if ($permission[34]) { ?>
      <li class="menu-item"><a href="<?= base_url().'ordertaking' ?>"><i class="material-icons">local_dining</i> Dine In and Take Out</a></li>
      <?php } ?>

      <li class="menu-item pl-3 border-top border-bottom py-2 font-weight-bold" style="letter-spacing: .3px"><span>Reports</span> </li>

      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Cashier Setup</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Sales Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Inventory Storage Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Inventory Vendor Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Inventory Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Courier Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Purchase Report</a></li>
      <li class="menu-item"><a href="#"><i class="fas fa-newspaper"></i> Inventory Incident Report</a></li>

      <li class="menu-item pl-3 border-top border-bottom py-2 font-weight-bold" style="letter-spacing: .3px"><span>Masterfile</span> </li>

      <?php if ($permission[4] || $permission[5] || $permission[6]) { ?>
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#users" aria-expanded="false" aria-controls="users"><i class="fas fa-users"></i> Users
        </a>
        <ul id="users" class="collapse" aria-labelledby="users">
          <?php if ($permission[4]) { ?>
            <li><a href="<?= base_url().'userdepartment' ?>"> User Department</a></li>
          <?php } ?>
          <?php if ($permission[5]) { ?>
            <li><a href="<?= base_url().'userdesignation' ?>"> User Designation</a></li>
          <?php } ?>
          <?php if ($permission[6]) { ?>
            <li><a href="<?= base_url().'useraccount' ?>"> User Account</a></li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?>

      <li class="menu-item"><a href="<?php echo base_url().'inventorystorage' ?>"><i class="fas fa-warehouse"></i> Inventory Storage</a></li>
      <li class="menu-item"><a href="<?php echo base_url().'inventoryvendor' ?>"><i class="fas fa-people-carry"></i> Inventory Vendor</a></li>
      <li class="menu-item"><a href="<?php echo base_url().'courier' ?>"><i class="fas fa-truck"></i> Courier Setup</a></li>

      <li class="menu-item pl-3 border-top border-bottom py-2 font-weight-bold" style="letter-spacing: .3px"><span>Inventory</span> </li>

      <?php if ($permission[14] || $permission[15]) { ?>
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#inventory_setup" aria-expanded="false" aria-controls="inventory_setup"><i class="fas fa-boxes"></i> Inventory Setup</a>
        <ul id="inventory_setup" class="collapse" aria-labelledby="inventory_setup">
          <?php if ($permission[14]) { ?>
            <li><a href="<?= base_url().'inventorygroup' ?>">Inventory Group</a></li>
          <?php } ?>
          <?php if ($permission[15]) { ?>
      ...
      <?php if ($permission[16] || $permission[17]) { ?>
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#purchase" aria-expanded="false" aria-controls="purchase"><i class="fas fa-shopping-basket"></i> Purchase</a>
        <ul id="purchase" class="collapse" aria-labelledby="purchase">
          <?php if ($permission[16]) { ?>
            <li><a href="<?= base_url().'purchaserequest' ?>">Purchase Request</a></li>
          <?php } ?>
          <?php if ($permission[17]) { ?>
      ...
      <?php if ($permission[18] || $permission[19] || $permission[20] || $permission[21] || $permission[22] || $permission[23]) { ?>
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#inventory_movement" aria-expanded="false" aria-controls="inventory_movement"><i class="fas fa-project-diagram"></i> Inventory Movement</a>
        <ul id="inventory_movement" class="collapse" aria-labelledby="inventory_movement">
          <?php if ($permission[18]) { ?>
            <li><a href="<?= base_url().'liststocks'?>">List of Stocks</a></li>
          <?php } ?>
          <?php if ($permission[18]) { ?>
          ...
          <?php } ?>
          <?php if ($permission[18]) { ?>
            <li><a href="<?= base_url().'transferrequest'?>">Transfer Request</a></li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?>

      <li class="menu-item pl-3 border-top border-bottom py-2 font-weight-bold" style="letter-spacing: .3px"><span>System Setting</span> </li>

      <?php if ($permission[2]) { ?>
      <li class="menu-item"><a href="<?= base_url().'company'?>"><i class="fa fa-building"></i> Company Setup</a></li>
      <?php } ?>
      <?php if ($permission[3]) { ?>
      <li class="menu-item"><a href="<?= base_url().'permission'?>"><i class="fas fa-user-lock"></i> Roles and Permission</a></li>
      <?php } ?>
      <?php if ($permission[7]) { ?>
      <li class="menu-item"><a href="<?= base_url().'approval'?>"><i class="fas fa-th-list"></i> Approval Setup</a></li>
      <?php } ?>
