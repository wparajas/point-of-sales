...
INSERT INTO `company_business` VALUES (62,1,1,1,'2020-10-05 08:53:13','2020-10-05 08:53:13'),(63,1,2,1,'2020-10-05 08:53:13','2020-10-05 08:53:13');
...
INSERT INTO `company_profile` VALUES (1,'BlackCoders Group Incorporated','Charles Malakas','09099054795','1701','Antel Global','Julia Vargas','Ortigas Extension','San Antonio','Mandaluyong','','1900','theblackcoders@gmail.com','https://www.theblackcoders.com','1.png','199-568-779-236','2020-09-17 23:36:01','2020-10-08 00:13:27');
...
INSERT INTO `invr_group` VALUES (1,'IGC-20-00001','Condiments','A condiment is a spice, sauce, or preparation that is added to foods',1,1,'2020-10-05 06:12:08','2020-10-08 03:36:47'),(9,'IGC-20-00002','Meat','Meat is a meat that meat the meatsssss',0,1,'2020-10-05 07:05:33','2020-10-05 07:27:30'),(10,'IGC-20-00010','Pork','Pork is an example of pork that pork the porks',1,1,'2020-10-05 07:06:12','2020-10-05 07:06:12');
/*!40000 ALTER TABLE `invr_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `invr_item`
--

DROP TABLE IF EXISTS `invr_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invr_item` (
  `invr_itemID` bigint(20) NOT NULL AUTO_INCREMENT,
  `invr_storageID` bigint(20) NOT NULL,
  `invr_groupID` bigint(20) NOT NULL,
  `invr_itemCode` varchar(100) NOT NULL,
  `invr_itemName` varchar(100) NOT NULL,
  `invr_itemBaseprice` decimal(15,2) NOT NULL,
  `measurementID` bigint(20) NOT NULL,
  `invr_itemReorder` int(11) NOT NULL,
  `invr_itemVat` int(11) NOT NULL,
  `invr_itemStatus` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`invr_itemID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `invr_item`
--

LOCK TABLES `invr_item` WRITE;
/*!40000 ALTER TABLE `invr_item` DISABLE KEYS */;
INSERT INTO `invr_item` VALUES (1,1,1,'IC-20-00001','Soy Sauce',150.00,12,20,1,1,1,'2020-10-05 23:06:59','2020-10-05 23:38:07'),(2,8,10,'IC-20-00011','UTAK',100.00,14,10,1,0,1,'2020-10-06 01:39:58','2020-10-06 02:30:45'),(3,9,1,'IC-20-00012','Oil',10.00,6,100,0,1,1,'2020-10-06 02:20:20','2020-10-06 03:05:03'),(4,10,1,'IC-20-00013','Oil',123.00,6,100,1,1,1,'2020-10-06 02:59:41','2020-10-06 03:05:28');
/*!40000 ALTER TABLE `invr_item` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `invr_storage` VALUES (1,NULL,'WAR-20-00001','Warehouse 1','Pasig City','F-1','B-1','L-1',1,1,'2020-09-24 08:01:59','2020-10-06 02:18:05'),(4,NULL,'WAR-20-00002','Warehouse 2','Cainta Rizal','F-2','B-1','L-2',1,2,'2020-09-24 23:09:26','2020-10-05 00:28:24'),(8,1,'WAR-20-00005','Warehouse 3','Pasig City','F-1','B-1','L-1',1,1,'2020-09-25 00:23:33','2020-10-06 00:22:11'),(9,1,'WAR-20-00009','Kitchen','Cainta Rizal','F-2','B-2','L-10',0,1,'2020-09-25 00:24:21','2020-10-08 03:39:43'),(10,NULL,'WAR-20-00010','Warehouse 12','Mandaluyong City','F-1','B-1','L-3',0,1,'2020-10-04 23:42:04','2020-10-08 03:39:29'),(11,NULL,'WAR-20-00011','Warehouse 4','Makati City','N/A','N/A','N/A',1,1,'2020-10-05 00:06:09','2020-10-05 00:28:39'),(12,2,'WAR-20-00013','Warehouse 5','Antipolo City','F-1','B-1','L-0',1,1,'2020-10-05 00:34:37','2020-10-05 01:19:04');
...
CREATE TABLE `measurements` (
  ...
  `measurement_category` varchar(255) NOT NULL,
  `measurement_number` double NOT NULL,
  `measurement_based` varchar(100) NOT NULL,
  `measurement_status` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `measurements` VALUES (1,'mm','Millimeter','Length',0.001,'meter',1,'2020-08-16 01:25:53'),(2,'cm','Centimeter','Length',0.01,'meter',1,'2020-08-16 01:25:53'),(3,'m','Meter','Length',1,'meter',1,'2020-08-16 01:25:53'),(4,'inch','Inches','Length',0.0254,'meter',1,'2020-08-16 01:25:53'),(5,'ft','Feet','Length',0.3048,'meter',1,'2020-08-16 01:25:53'),(6,'L','Liter','Volume',1,'liter',1,'2020-08-16 01:25:53'),(7,'ml','Milliliter','Volume',0.0001,'liter',1,'2020-08-16 01:25:53'),(8,'teaspoon','Teaspoon','Volume',0.00492892,'liter',1,'2020-08-16 01:25:53'),(9,'tablespoon','Tablespoon','Volume',0.01478676,'liter',1,'2020-08-16 01:25:53'),(10,'cup','Cup','Volume',0.23658824,'liter',1,'2020-08-16 01:25:53'),(11,'gal','Gallon','Volume',4.546092,'liter',1,'2020-08-16 01:25:53'),(12,'g','Gram','Weight',1,'gram',1,'2020-08-16 01:25:53'),(13,'kg','Kilogram','Weight',1000,'gram',1,'2020-08-16 01:25:53'),(14,'pcs','Pieces','Pieces',1,'pieces',1,'2020-10-05 23:05:23');
...
INSERT INTO `pos_rolemstr` VALUES (1,'Administrator',1),(2,'Cashier',1),(3,'IT',1),(4,'Accounting',1);
...
INSERT INTO `user_account` VALUES (1,1,1,1,1,'UC-20-00001','admin','admin','Akosi','Hatdog','Admin','09099054766','2020-10-03',1,1,1,'2020-09-07 02:49:19','2020-10-08 03:29:38'),(2,1,2,1,1,'UC-20-00002','cashier','cashier','Akosi','','Cashier','09213123543','2020-10-02',0,1,1,'2020-09-07 02:49:19','2020-10-08 03:29:42'),(3,1,4,1,1,'UC-20-00003','arjaydiangzon','arjaydiangzon','RJ','','Diangzon','09321321312','2020-10-08',0,1,1,'2020-10-08 03:28:57','2020-10-08 03:31:01');
...
INSERT INTO `user_department` VALUES (1,'DEP-20-00001','Information Technology',1,'2020-09-07 02:41:46','2020-10-02 03:55:50'),(2,'DEP-20-00002','Sales',1,'2020-09-07 02:44:57','2020-10-08 03:56:24'),(3,'DEP-20-00003','Finance',0,'2020-10-02 04:00:13','2020-10-08 03:56:48');
...
INSERT INTO `user_designation` VALUES (1,1,'DES-20-00001','Supervisor',0.00,1,'2020-09-07 02:42:30','2020-10-08 03:54:04'),(2,2,'DES-20-00002','Cashier',0.00,1,'2020-09-07 02:42:30','2020-10-08 03:56:12'),(3,2,'DES-20-00003','MIC',2333.00,1,'2020-10-02 04:00:41','2020-10-08 03:54:19');
...
-- Dump completed on 2020-10-09  7:40:25
